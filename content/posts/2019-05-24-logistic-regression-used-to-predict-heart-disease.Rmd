---
title: 'Logistic regression used to predict heart disease'
author: Jordan Arlan
date: '2019-05-24'
slug: logistic-regression-used-to-predict-heart-disease
categories:
  - Machine learning
tags:
  - Health
...
<p><img src="https://s3.amazonaws.com/assets.datacamp.com/production/project_445/img/run31.png" height="300" width="1000"></p>
...
<p><img src="https://s3.amazonaws.com/assets.datacamp.com/production/project_445/img/datadict.png" height="500" width="750"></p>## 
...
hd_data %>% mutate(sex = factor(hd_data$sex, levels = 0:1, labels = c("Female", "Male")))-> hd_data
